...
<template>
  <div class="admin__pages-comments panel">
    ...
    <div class="panel__graphics">
      <div class="panel__graphics-left">
        ...
        <div class="panel-dynamics__graph">
          <v-chart class="chart" :option="timePublicationsComment" autoresize />
        </div>
      </div>
    </div>
  </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { timePublicationsComment, dynamicsComment };
  },
});
</script>
