  ...
  <div>
    <div class="search-filter">
      <div class="search-filter__block name">
        ...
        <input class="search__input" placeholder="Введите имя" type="text" id="search-people-name" v-model="firstName" />
      </div>
      <div class="search-filter__block lastname">
        <label class="search__label" for="search-people-lastname">Фамилия:</label>
        <input class="search__input" placeholder="Введите фамилию" type="text" id="search-people-lastname" v-model="lastName" />
      </div>
