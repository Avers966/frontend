    ...
    <div class="footer__waves-container">
      ...
      >
        ...
        <g class="footer__parallax">
          <use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(33, 164, 93, 1)" />
          <use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(27, 129, 73, 0.8)" />
          <use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(13, 157, 78, 0.4)" />
          <use xlink:href="#gentle-wave" x="48" y="7" fill="rgba(22, 246, 123, 0.2)" />
        </g>
      </svg>
    </div>
  </div>
